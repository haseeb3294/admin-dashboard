                ...
                <div class="col-xxl-4 col-sm-6 box-col-6">
                    <div class="card profile-box">
                        <div class="card-body">
                            ...
                            <div class="cartoon"><img class="img-fluid" src="{{asset('assets/app/images/dashboard/cartoon.svg')}}" alt="vector women with leptop"></div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="card-body">
                                    <div class="widget-content">
                                        <div class="widget-round secondary">
                                            <div class="bg-round">
                                                <svg class="svg-fill">
                                                    <use href="{{asset('assets/app/svg/icon-sprite.svg#cart')}}"> </use>
                                                </svg>
                                                <svg class="half-circle svg-fill">
                                                    <use href="{{asset('assets/app/svg/icon-sprite.svg#halfcircle')}}"></use>
                                                </svg>
                                            </div>
                                        </div>
                                        <div>
                                    ...
                                    <div class="card-body">
                                        <div class="widget-content">
                                            <div class="widget-round primary">
                                                <div class="bg-round">
                                                    <svg class="svg-fill">
                                                        <use href="{{asset('assets/app/svg/icon-sprite.svg#tag')}}"> </use>
                                                    </svg>
                                                    <svg class="half-circle svg-fill">
                                                        <use href="{{asset('assets/app/svg/icon-sprite.svg#halfcircle')}}"></use>
                                                    </svg>
                                ...
                                <div class="card-body">
                                    <div class="widget-content">
                                        <div class="widget-round warning">
                                            <div class="bg-round">
                                                <svg class="svg-fill">
                                                    <use href="{{asset('assets/app/svg/icon-sprite.svg#return-box')}}"> </use>
                                                </svg>
                                                <svg class="half-circle svg-fill">
                                                    <use href="{{asset('assets/app/svg/icon-sprite.svg#halfcircle')}}"></use>
                                                </svg>
                                    ...
                                    <div class="card-body">
                                        <div class="widget-content">
                                            <div class="widget-round success">
                                                <div class="bg-round">
                                                    <svg class="svg-fill">
                                                        <use href="{{asset('assets/app/svg/icon-sprite.svg#rate')}}"> </use>
                                                    </svg>
                                                    <svg class="half-circle svg-fill">
                                                        <use href="{{asset('assets/app/svg/icon-sprite.svg#halfcircle')}}"></use>
                                                    </svg>
