...
!function () {
    ...
    var s = document.querySelector("#swiper-with-pagination-cards"), s = (s && new Swiper(s, {
        loop: !0,
        autoplay: {delay: 2500, disableOnInteraction: !1},
        pagination: {clickable: !0, el: ".swiper-pagination"}
    }), document.querySelector("#revenueGenerated")), i = {
        ...
        fill: {type: "gradient", gradient: {shade: r, shadeIntensity: .8, opacityFrom: .6, opacityTo: .1}},
        ...
        tooltip: {enabled: !1}
    }, s = (null !== s && new ApexCharts(s, i).render(), document.querySelector("#weeklyEarningReports")), i = {
        ...
        xaxis: {
            ...
            axisBorder: {show: !1},
            axisTicks: {show: !1},
            labels: {style: {colors: a, fontSize: "13px", fontFamily: "Public Sans"}}
        },
        yaxis: {labels: {show: !1}},
        tooltip: {enabled: !1},
        responsive: [{breakpoint: 1025, options: {chart: {height: 199}}}]
    }, s = (null !== s && new ApexCharts(s, i).render(), document.querySelector("#supportTracker")), i = {
        series: [85],
        ...
        plotOptions: {
            radialBar: {
                ...
                dataLabels: {
                    ...
                    }, value: {offsetY: 10, color: t, fontSize: "38px", fontWeight: "500", fontFamily: "Public Sans"}
                }
            }
        },
        ...
        responsive: [{breakpoint: 1025, options: {chart: {height: 330}}}, {
            breakpoint: 769,
            options: {chart: {height: 280}}
        }]
    }, s = (null !== s && new ApexCharts(s, i).render(), document.querySelector("#totalEarningChart")), i = {
        series: [{name: "Earning", data: [15, 10, 20, 8, 12, 18, 12, 5]}, {
            name: "Expense",
        ...
        yaxis: {labels: {show: !1}},
        responsive: [{breakpoint: 1468, options: {plotOptions: {bar: {columnWidth: "22%"}}}}, {
            breakpoint: 1197,
            options: {chart: {height: 228}, plotOptions: {bar: {borderRadius: 8, columnWidth: "26%"}}}
        }, {
            breakpoint: 783,
            options: {chart: {height: 232}, plotOptions: {bar: {borderRadius: 6, columnWidth: "28%"}}}
    ...
    s.length && (s.DataTable({
        ...
        columns: [{data: ""}, {data: "id"}, {data: "project_name"}, {data: "project_leader"}, {data: ""}, {data: "status"}, {data: ""}],
        columnDefs: [{
            className: "control",
            searchable: !1,
            orderable: !1,
            ...
            targets: 2, responsivePriority: 4, render: function (e, t, a, r) {
                var o = a.project_img, s = a.project_name, i = a.date;
            ...
            targets: 4, orderable: !1, searchable: !1, render: function (e, t, a, r) {
            ...
            targets: -2, render: function (e, t, a, r) {
                a = a.status;
            ...
            targets: -1, searchable: !1, title: "Actions", orderable: !1, render: function (e, t, a, r) {
