...
document.getElementById("layout-menu") && (isHorizontalLayout = document.getElementById("layout-menu").classList.contains("menu-horizontal")), function () {
    ...
    var a, n = document.querySelector(".dropdown-style-switcher"),
        ...
        }), n = n.querySelector("i"), "light" === s ? (n.classList.add("ti-sun"), new bootstrap.Tooltip(n, {
            title: "Light Mode",
            fallbackPlacements: ["bottom"]
        })) : "dark" === s ? (n.classList.add("ti-moon"), new bootstrap.Tooltip(n, {
            title: "Dark Mode",
            fallbackPlacements: ["bottom"]
    ...
    var t, a, e, n = $(".search-toggler"), s = $(".search-input-wrapper"), o = $(".search-input"),
        l = $(".content-backdrop");
    n.length && n.on("click", function () {
        ...
        o.typeahead({
            ...
            o.val(""), e.typeahead("val", ""), s.addClass("d-none"), l.addClass("fade").removeClass("show")
        }), o.on("keyup", function () {
