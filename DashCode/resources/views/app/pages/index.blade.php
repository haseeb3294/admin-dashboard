                    ...
                    <div class="grid grid-cols-12 gap-5 mb-5">
                        <div class="2xl:col-span-3 lg:col-span-4 col-span-12">
                            <div class="bg-no-repeat bg-cover bg-center p-4 rounded-[6px] relative"
                                 style="background-image: url({{asset('assets/app/images/all-img/widget-bg-1.png')}})">
                                                            ...
                                                            <div class="flex items-center">
                                                                <div class="flex-none">
                                                                    <div
                                                                        ...
                                                                        <img
                                                                            src="{{asset('assets/app/images/users/user-1.jpg')}}"
                                                                            alt=""
                                                            ...
                                                            <div class="flex items-center">
                                                                <div class="flex-none">
                                                                    <div
                                                                        class="w-8 h-8 rounded-[100%] ltr:mr-3 rtl:ml-3">
                                                                        <img
                                                                            src="{{asset('assets/app/images/users/user-2.jpg')}}"
                                                                            alt=""
                                                                            class="w-full h-full rounded-[100%] object-cover">
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="flex items-center">
                                                                <div class="flex-none">
                                                                    <div
                                                                        class="w-8 h-8 rounded-[100%] ltr:mr-3 rtl:ml-3">
                                                                        <img
                                                                            src="{{asset('assets/app/images/users/user-3.jpg')}}"
                                                                            alt=""
                                                                            class="w-full h-full rounded-[100%] object-cover">
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="flex items-center">
                                                                <div class="flex-none">
                                                                    <div
                                                                        class="w-8 h-8 rounded-[100%] ltr:mr-3 rtl:ml-3">
                                                                        <img
                                                                            src="{{asset('assets/app/images/users/user-4.jpg')}}"
                                                                            alt=""
                                                                            class="w-full h-full rounded-[100%] object-cover">
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="flex items-center">
                                                                <div class="flex-none">
                                                                    <div
                                                                        class="w-8 h-8 rounded-[100%] ltr:mr-3 rtl:ml-3">
                                                                        <img
                                                                            src="{{asset('assets/app/images/users/user-5.jpg')}}"
                                                                            alt=""
                                                                            class="w-full h-full rounded-[100%] object-cover">
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="flex items-center">
                                                                <div class="flex-none">
                                                                    <div
                                                                        class="w-8 h-8 rounded-[100%] ltr:mr-3 rtl:ml-3">
                                                                        <img
                                                                            src="{{asset('assets/app/images/users/user-6.jpg')}}"
                                                                            alt=""
                                                                            class="w-full h-full rounded-[100%] object-cover">
                                                                    </div>
                                                                </div>
                                    ...
                                    <div>
                                        <ul class="list-item space-y-3 h-full overflow-x-auto">
                                            ...
                                            <li class="flex items-center space-x-3 rtl:space-x-reverse border-b border-slate-100 dark:border-slate-700 last:border-b-0 pb-3 last:pb-0">
                                                <div>
                                                    <div class="w-8 h-8 rounded-[100%]">
                                                        <img src="{{asset('assets/app/images/users/user-2.jpg')}}" alt=""
                                                             class="w-full h-full rounded-[100%] object-cover">
                                                    </div>
                                                </div>
                                                <div
                                            ...
                                            <li class="flex items-center space-x-3 rtl:space-x-reverse border-b border-slate-100 dark:border-slate-700 last:border-b-0 pb-3 last:pb-0">
                                                <div>
                                                    <div class="w-8 h-8 rounded-[100%]">
                                                        <img src="{{asset('assets/app/images/users/user-3.jpg')}}" alt=""
                                                             class="w-full h-full rounded-[100%] object-cover">
                                                    </div>
                                                </div>
                                                <div
                                            ...
                                            <li class="flex items-center space-x-3 rtl:space-x-reverse border-b border-slate-100 dark:border-slate-700 last:border-b-0 pb-3 last:pb-0">
                                                <div>
                                                    <div class="w-8 h-8 rounded-[100%]">
                                                        <img src="{{asset('assets/app/images/users/user-4.jpg')}}" alt=""
                                                             class="w-full h-full rounded-[100%] object-cover">
                                                    </div>
                                                </div>
                                                <div
                                            ...
                                            <li class="flex items-center space-x-3 rtl:space-x-reverse border-b border-slate-100 dark:border-slate-700 last:border-b-0 pb-3 last:pb-0">
                                                <div>
                                                    <div class="w-8 h-8 rounded-[100%]">
                                                        <img src="{{asset('assets/app/images/users/user-5.jpg')}}" alt=""
                                                             class="w-full h-full rounded-[100%] object-cover">
                                                    </div>
                                                </div>
                                                <div
                                            ...
                                            <li class="flex items-center space-x-3 rtl:space-x-reverse border-b border-slate-100 dark:border-slate-700 last:border-b-0 pb-3 last:pb-0">
                                                <div>
                                                    <div class="w-8 h-8 rounded-[100%]">
                                                        <img src="{{asset('assets/app/images/users/user-6.jpg')}}" alt=""
                                                             class="w-full h-full rounded-[100%] object-cover">
                                                    </div>
                                                </div>
                                                <div
