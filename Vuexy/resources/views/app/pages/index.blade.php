    ...
    <div class="row">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="row">
                            ...
                            <div class="row">
                                <div
                                        class="col-lg-7 col-md-9 col-12 order-2 order-md-1"
                                >
        ...
        <div class="col-lg-6 mb-4">
            <div class="card h-100">
                <div
                        class="card-header pb-0 d-flex justify-content-between mb-lg-n4"
                >
                    <div class="card-title mb-0">
                        <h5 class="mb-0">Earning Reports</h5>
                        <small class="text-muted"
                        >Weekly Earnings Overview</small
                        >
                    </div>
                    <div class="dropdown">
                        <button
                ...
                <div class="card-body">
                    <div class="row">
                        <div
                                class="col-12 col-md-4 d-flex flex-column align-self-end"
                        >
                            <div
                ...
                <div class="card-body">
                    <ul class="p-0 m-0">
                        <li class="d-flex align-items-center mb-4">
                            <img
                                    src="https://demos.pixinvent.com/vuexy-html-admin-template/assets/svg/flags/us.svg"
                                    alt="User"
                        ...
                        <li class="d-flex align-items-center mb-4">
                            <img
                                    src="https://demos.pixinvent.com/vuexy-html-admin-template/assets/svg/flags/br.svg"
                                    alt="User"
                                    class="rounded-circle me-3"
                                    width="34"
                            />
                        ...
                        <li class="d-flex align-items-center mb-4">
                            <img
                                    src="https://demos.pixinvent.com/vuexy-html-admin-template/assets/svg/flags/in.svg"
                                    alt="User"
                                    class="rounded-circle me-3"
                                    width="34"
                            />
                        ...
                        <li class="d-flex align-items-center mb-4">
                            <img
                                    src="https://demos.pixinvent.com/vuexy-html-admin-template/assets/svg/flags/au.svg"
                                    alt="User"
                                    class="rounded-circle me-3"
                                    width="34"
                            />
                        ...
                        <li class="d-flex align-items-center mb-4">
                            <img
                                    src="https://demos.pixinvent.com/vuexy-html-admin-template/assets/svg/flags/fr.svg"
                                    alt="User"
                                    class="rounded-circle me-3"
                                    width="34"
                            />
                        ...
                        <li class="d-flex align-items-center">
                            <img
                                    src="https://demos.pixinvent.com/vuexy-html-admin-template/assets/svg/flags/cn.svg"
                                    alt="User"
                                    class="rounded-circle me-3"
                                    width="34"
                            />
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-start my-4">
                        <div
                                class="badge rounded bg-label-primary p-2 me-3 rounded"
                        >
                            <i class="ti ti-currency-dollar ti-sm"></i>
                        </div>
                        <div
                    ...
                    <div class="d-flex align-items-start">
                        <div
                                class="badge rounded bg-label-secondary p-2 me-3 rounded"
                        >
                            <i class="ti ti-brand-paypal ti-sm"></i>
                        </div>
                        <div
                ...
                <div class="card-body">
                    <ul class="list-unstyled mb-0">
                        <li class="mb-3 pb-1">
                            <div class="d-flex align-items-start">
                                <div
                                        class="badge bg-label-secondary p-2 me-3 rounded"
                                >
        ...
        <!-- Projects table -->
        <div
                class="col-12 col-xl-8 col-sm-12 order-1 order-lg-2 mb-4 mb-lg-0"
        >
            <div class="card">
